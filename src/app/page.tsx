  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-50 border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-bold sm:text-xl">Beeing Rich</h1>
          </div>
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 px-4 py-16 sm:py-24 lg:py-32">
          <div className="container mx-auto text-center">
            <Badge className="mb-6 bg-blue-100 text-blue-700 hover:bg-blue-200 text-xs sm:text-sm">
              Sistema Completo de Gestão Imobiliária
            </Badge>
            <h2 className="mb-6 text-3xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl xl:text-7xl">
            ...
            <p className="mx-auto mb-10 max-w-3xl text-base text-gray-600 sm:text-lg lg:text-xl px-4">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4 px-4">
              <Button size="lg" className="w-full sm:w-auto h-12 bg-blue-600 px-8 text-base sm:text-lg hover:bg-blue-700" asChild>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <Card className="border-2 transition-all hover:border-blue-200 hover:shadow-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Gestão de Imóveis</CardTitle>
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-blue-600" />
                      Status e disponibilidade em tempo real
                    </li>
                    <li className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-blue-600" />
